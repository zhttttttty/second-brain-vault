...
### Project (`02_Projects/项目名/Project.md`)
...
### Daily Note (`01_Daily/YYYY-MM-DD.md`)
...
- 新捕获、尚未判断归属 → `05_Tasks/Inbox.md`
- 非项目任务 → `05_Tasks/Tasks.md`
