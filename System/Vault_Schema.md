...
- 当前核心领域：尚未设置；完成 `Context/About_Me.md` 与 `Context/Current_Priorities.md` 后再登记
...
| 机制 | 表达什么 | 示例 |
|------|----------|------|
| 文件夹 | 内容的物理位置与工作流阶段 | `04_References/01_Inbox/` |
...
本分类法约束 `Context/`、`01_Daily/`、`02_Projects/`、`03_Knowledge/`、`04_References/`、`05_Tasks/` 中的正式内容。
...
| **归档卡片** | 内容被完全取代 → 移到 `06_Archive/`，从索引/MOC 移除 |
